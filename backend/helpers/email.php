...
function sendInviteEmail($to, $inviteLink, $inviteType, $firmName = '', $firmId = null) {
    ...
    $subject = "You're invited to join " . ($firmName ?: 'DocqFlow') . " as a " . $roleLabel;
    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, \'Helvetica Neue\', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #e5e7eb; border-top: none;">
            ...
            <p style="font-size: 16px; margin-bottom: 20px;">
                You\'ve been invited to join <strong>' . htmlspecialchars($firmName ?: 'DocqFlow') . '</strong> as a ' . htmlspecialchars($roleLabel) . '.
            </p>
...
function sendPasswordResetEmail($to, $resetLink, $userName = '') {
    $subject = 'Reset Your DocqFlow Password';
    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, \'Helvetica Neue\', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #e5e7eb; border-top: none;">
            ...
            <p style="font-size: 16px; margin-bottom: 20px;">
                We received a request to reset your password for your DocqFlow account.
            </p>
            <p style="font-size: 16px; margin-bottom: 30px;">
    ...
    if (defined('SMTP_ENABLED') && SMTP_ENABLED && 
        ...
        return sendEmailViaSMTP($to, $subject, $htmlContent, $userName);
    } else {
 ...
 * Send email via SMTP
 */
function sendEmailViaSMTP($to, $subject, $htmlContent, $userName = '') {
    $host = SMTP_HOST;
    $port = defined('SMTP_PORT') ? SMTP_PORT : 587;
    $secure = defined('SMTP_SECURE') ? SMTP_SECURE : 'tls';
    $username = SMTP_USER;
    $password = SMTP_PASS;
    $fromEmail = defined('SMTP_FROM_EMAIL') ? SMTP_FROM_EMAIL : 'noreply@docuflow.com';
    $fromName = defined('SMTP_FROM_NAME') ? SMTP_FROM_NAME : 'DocqFlow';
